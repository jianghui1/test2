 ...
 *  @param data       数据
 */
- (void)requestSucess:(HttpRequest *)networking data:(id)data;
 ...
 *  @param error      错误信息
 */
- (void)requestFailed:(HttpRequest *)networking error:(NSError *)error;
 ...
 *  @param error      错误信息
 */
- (void)userCanceledFailed:(HttpRequest *)networking error:(NSError *)error;
